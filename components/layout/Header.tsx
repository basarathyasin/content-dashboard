...
export default function Header() {
  ...
  const notifications = [
    ...
    { id: 2, text: "Your favorites list was updated", time: "1h ago", unread: true },
      ...
      <div className="flex items-center gap-2">
              ...
              <div className="p-2">
                {settingsOptions.map((opt) => (
                  <button
                    key={opt.id}
                    onClick={() =>
                      setLocalSettings((prev) => ({ ...prev, [opt.id]: !prev[opt.id] }))
                    }
        ...
        <button className="flex items-center gap-2.5 pl-1 pr-3 py-1.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors group">
          ...
          <div className="text-left">
            <p className="text-xs font-semibold text-gray-900 dark:text-white leading-tight">John</p>
